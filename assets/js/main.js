...
(function() {
   ...
   emailjs.init({
      publicKey: "UVCS2-cHh34AhEvc4",
      });
})();

saContactForm = document.getElementById("sa-contact-form");
saContactFormAlert = document.querySelector(".contact-form-alert");

saContactForm.addEventListener('submit', function(event) {
   event.preventDefault();
   // these IDs from the previous steps
   emailjs.sendForm('sajibabd17', 'template_sk30lje', '#sa-contact-form')
      .then(() => {
         // console.log('SUCCESS!');
